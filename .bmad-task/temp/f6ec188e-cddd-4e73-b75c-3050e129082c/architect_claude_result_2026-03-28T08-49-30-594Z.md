...
:root {
  ...
  --color-teal: #6BCCC8;
  --color-teal-soft: rgba(107, 204, 200, 0.15);
  --color-white: #FFFFFF;
...
### Deployment Process
1. Develop child theme locally in LocalWP
2. Export child theme as ZIP
3. Upload to production via WordPress admin (Appearance → Themes → Add New → Upload)
4. Configure ACF field groups (export/import JSON)
5. Add content via WordPress admin
